...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [newProdPromocao, setNewProdPromocao] = useState(false);
  const [newProdDestaque, setNewProdDestaque] = useState(false);
  ...
  const handleAddProduct = async (e: React.FormEvent) => {
    ...
    const newProd: Product = {
      ...
      promocao: newProdPromocao,
      destaque: newProdDestaque,
      rating: 5.0,
      reviewsCount: 1
    };
